...
const StatCard = ({ title, value, subtext, icon: Icon, colorClass, trend }) => (
    <div className={`p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 group relative overflow-hidden ${colorClass} text-white`}>
