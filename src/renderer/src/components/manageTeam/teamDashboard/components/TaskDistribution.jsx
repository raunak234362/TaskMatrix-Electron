...
const TaskDistribution = ({ teamStats }) => {
  const distributionData = useMemo(() => {
    ...
    return [
      { label: "Modelling", value: counts.modelling || 0, icon, color: "text-green-700", bg: "bg-green-100" },
      { label: "Model Checking", value: counts.modelChecking || 0, icon2, color: "text-emerald-600", bg: "bg-emerald-50" },
      { label: "Detailing", value: counts.detailing || 0, icon, color: "text-teal-600", bg: "bg-teal-50" },
      { label: "Detail Checking", value: counts.detailChecking || 0, icon, color: "text-cyan-600", bg: "bg-cyan-50" },
      { label: "Erection", value: counts.erection || 0, icon, color: "text-green-800", bg: "bg-green-50" },
      { label: "Erection Checking", value: counts.erectionChecking || 0, icon, color: "text-lime-600", bg: "bg-lime-50" },
    ];
