...
const Header = ({ isMinimized, toggleSidebar }) => {
  ...
  return (
    <header className="sticky top-0 z-40 flex flex-row justify-between items-center gap-2 w-full py-2 px-6 bg-white rounded-xl shadow-[0_4px_15px_rgb(0,0,0,0.03)] mb-2">
      {/* Left Toggle & Title */}
      <div>
