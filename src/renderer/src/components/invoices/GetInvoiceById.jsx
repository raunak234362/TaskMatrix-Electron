      ...
      <div className="modal-root fixed inset-0 z-1000 flex items-start justify-center overflow-auto bg-black/80 backdrop-blur-xl pt-0 pb-0">
        ...
        >
          ...
          <div className="w-[210mm] min-h-[297mm] bg-white p-[15mm] flex flex-col shadow-none print:shadow-none mx-auto box-border font-roboto print-page">
                  ...
                  <tr className="border-b border-black">
                    <td colSpan={7} className="px-3 py-1">
                      <div className="flex gap-2 text-[12px] items-center">
                        <span className="">Total Invoice Value (in Words):</span>
            ...
            <div className="mb-3">
              <h4 className="text-green-600 text-[12px] mb-1 tracking-tight">Instructions</h4>
              <p className="text-xs text-gray-700 leading-relaxed border border-green-500/20 p-2 mb-1 rounded-lg bg-green-50/30">
                Consulting Proforma Invoice for Steel Detailing of {invoice.jobName} - Cobb P.O #
              </p>
              <p className="text-xs text-black">
                All payments to be made to <span className="uppercase">Whiteboard Technologies LLC</span> in US Dollars via Wire Transfers within 15 days.
              </p>
            </div>

            <div className="mt-auto flex flex-col items-center pr-10 self-end">
              <p className="text-[#6bbd45] font-bold text-[13px] mb-8 italic text-center">Thank you for your business!</p>
              <div className="text-center w-[220px]">
                <p className="text-[12px] font-bold text-gray-900 mb-10">For Whiteboard Technologies Pvt Ltd</p>
                <div className="border-t border-[#6bbd45]/20 w-full pt-1">
                  <p className="text-[10px] font-bold text-black uppercase tracking-wider">Authorised signatory</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-16">
                  <div className="flex flex-col items-start justify-start gap-1">
                    <span className="uppercase text-[12px]"><span className="text-[#6bbd45]">Tel:</span> USA: +1 612.605.5833</span>
                    <span className="uppercase text-[12px]">INDIA: +1 770.256.6888</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="text-[#6bbd45] uppercase text-[12px]">Email: <span className="text-gray-500 normal-case font-medium">raj@whiteboardtec.com</span></span>
                    <span className="text-[#6bbd45] uppercase text-[12px]">Web: <span className="text-gray-500 normal-case font-medium">www.whiteboardtec.com</span></span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-[210mm] min-h-[297mm] bg-white p-[20mm] pt-[15mm] relative flex flex-col shrink-0 overflow-visible box-border border-t-10 border-gray-50 print-page">
            <div className="flex justify-between items-end mb-5">
              <div>
                <h1 className="text-[28px] font-medium text-[#6bbd45] mb-2 leading-none" style={{ fontFamily: "serif" }}>Whiteboard Technologies LLC</h1>
              </div>
              <img src={logo} alt="Logo" className="h-24 object-contain" />
            </div>
            <div className="h-px bg-[#6bbd45] w-full mb-3"></div>
            <p className="mb-10 text-[14px] leading-relaxed text-gray-700">Please initiate the ACH/Wire Transfer in <span className="underline">USD</span> currency from your local Bank with the following information:</p>

            <h3 className="text-[15px] text-gray-800 mb-10">ACH / Domestic Wire instructions:</h3>
            ...
            {invoice?.fabricator?.bankAccount ? (
              <div className="grid grid-cols-[250px_1fr] gap-y-10 text-[14px] text-gray-700">
                ...
                <span className="font-medium text-gray-900">{invoice.fabricator.bankAccount.abaRoutingNumber || "—"}</span>

                <span className="">Account number:</span>
                <span className="font-medium text-gray-900">{invoice.fabricator.bankAccount.accountNumber || "—"}</span>

                <span className="">Account type:</span>
                <span className="text-gray-900">{invoice.fabricator.bankAccount.accountType || "—"}</span>

                <span className="">Recipient / beneficiary information*:</span>
                <span className="text-gray-900">{invoice.fabricator.bankAccount.accountName || "Whiteboard Technologies LLC."}</span>

                <span className="">Beneficiary address:</span>
                <span className="text-gray-900 whitespace-pre-wrap leading-snug">{invoice.fabricator.bankAccount.beneficiaryAddress || "—"}</span>

                <span className="">Bank information:</span>
                <span className="text-gray-900">{invoice.fabricator.bankAccount.bankName || "—"}</span>

                <span className="">Bank Address:</span>
                <span className="text-gray-900 whitespace-pre-wrap leading-snug">{invoice.fabricator.bankAddress || "—"}</span>
              </div>
            ) : (
              <div className="bg-red-50 p-8 rounded text-center">
                <p className="text-red-500 ">No bank account information attached to this invoice.</p>
              </div>
            )}

            <p className="mt-12 text-[12px] text-gray-600 font-normal">*Use this name as the recipient's name of the wire.</p>
