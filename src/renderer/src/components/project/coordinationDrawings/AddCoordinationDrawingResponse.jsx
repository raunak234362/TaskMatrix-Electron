...
const AddCoordinationDrawingResponse = ({ drawingId, onCancel, onSuccess }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-black shadow-xl overflow-hidden">
      <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-slate-50">
        <h3 className="text-sm font-black uppercase tracking-widest text-slate-700">Add Response</h3>
