                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input
                                ...
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition-all ${errors.quantity ? "border-red-500" : "border-gray-300"
                                    }`}
                            />
                            {errors.quantity && (
                                <p className="text-red-500 text-xs mt-1">
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition-all ${errors.hoursPerQty ? "border-red-500" : "border-gray-300"
                                    }`}
                            />
                            {errors.hoursPerQty && (
                                <p className="text-red-500 text-xs mt-1">
                                    {errors.hoursPerQty.message}
                                </p>
                            )}
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition-all ${errors.totalHours ? "border-red-500" : "border-gray-300"
                                    }`}
                            />
                            {errors.totalHours && (
                                <p className="text-red-500 text-xs mt-1">
