      ...
      <div className="flex flex-col w-full h-full">
        ...
        <div className="px-3 py-2 backdrop-blur-2xl bg-linear-to-t from-white/60 to-white/80 rounded-t-2xl flex flex-wrap items-center justify-center md:justify-end gap-3">
          <button
            ...
            className={`px-4 md:px-6 py-2 md:py-3 rounded-[1.25rem] text-sm md:text-base font-bold transition-all shadow-sm ${activeTab === "teamDashboard"
          ...
          <button
            ...
            className={`px-4 md:px-6 py-2 md:py-3 rounded-[1.25rem] text-sm md:text-base font-bold transition-all shadow-sm ${activeTab === "manageEmployee"
                ? "bg-green-500 text-white shadow-[0_8px_20px_-4px_rgba(34,197,94,0.4)] hover:shadow-[0_12px_24px_-4px_rgba(34,197,94,0.5)]"
                : "bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:text-green-600"
              }`}
          >
          ...
          {(userRole === "ADMIN" || userRole === "HUMAN_RESOURCE") && (
            <button
              ...
              className={`px-4 md:px-6 py-2 md:py-3 rounded-[1.25rem] text-sm md:text-base font-bold transition-all shadow-sm ${activeTab === "manageDepartment"
                  ? "bg-green-500 text-white shadow-[0_8px_20px_-4px_rgba(34,197,94,0.4)] hover:shadow-[0_12px_24px_-4px_rgba(34,197,94,0.5)]"
                  : "bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:text-green-600"
                }`}
            >
          ...
          {(userRole === "ADMIN" ||
            ...
            userRole === "HUMAN_RESOURCE") && (
              <button
                ...
                className={`px-4 md:px-6 py-2 md:py-3 rounded-[1.25rem] text-sm md:text-base font-bold transition-all shadow-sm ${activeTab === "manageTeam"
                    ? "bg-green-500 text-white shadow-[0_8px_20px_-4px_rgba(34,197,94,0.4)] hover:shadow-[0_12px_24px_-4px_rgba(34,197,94,0.5)]"
                    : "bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:text-green-600"
                  }`}
              >
