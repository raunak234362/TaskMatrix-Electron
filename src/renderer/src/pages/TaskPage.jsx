...
const TaskPage = () => {
  ...
  return (
    <div className="h-full w-full flex flex-col min-h-0">
      <div className="relative z-100 px-3 py-2 backdrop-blur-2xl bg-linear-to-t from-white/60 to-white/80 rounded-none flex flex-wrap items-center justify-center md:justify-end gap-3 shrink-0">
        <button
